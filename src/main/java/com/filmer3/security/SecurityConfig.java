...
import com.filmer3.config.CustomAccessDeniedHandler;
import com.filmer3.security.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/","/error","/forbidden","/layouts","/login","/usuario/registro",
				...
				"peliculas/cargar-peli", "/peliculas/listado","/buscar/**")
		.permitAll()
